...
public class ClinicalService {
    ...
    public PrescriptionResponse createPrescription(UUID cabinetId, UUID patientId, PrescriptionRequest request) {
        ensurePatient(cabinetId, patientId);
    ...
    private void ensurePatient(UUID cabinetId, UUID patientId) {
        patientRepository.findByIdAndCabinetId(patientId, cabinetId)
                .orElseThrow(com.kineplan.patient.application.PatientNotFoundException::new);
    }
